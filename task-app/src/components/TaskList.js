      ...
      <ul>
        {tasks.map((t, index) => (
          ...
          >
            ...
            <button className="mr-2 bg-green-500 hover:bg-green-600 text-white py-1 px-3 rounded-lg" onClick={() => startEditTasks(index)}>
              Edit
            </button>
            <button className="bg-red-500 hover:bg-red-600 text-white py-1 px-3 rounded-lg" onClick={() => deleteTask(index)}>
              Delete
            </button>
            </div>
          </li>
